export default function InputNumberItem() {
    return (
        <div className='rounded-lg border border-gray-200 bg-white px-3 py-2 dark:border-gray-700 dark:bg-slate-900 ' data-hs-input-number>
            <div className='flex w-full items-center justify-between gap-x-5'>
                <div className='grow'>
                    <span className='block text-xs text-gray-500 dark:text-gray-400'>Select quantity</span>
                    <input
