export default function TogglePasswordItem(props: any) {
    const { groupId } = props;

    return (
        <div className='space-y-5' data-hs-toggle-password-group>
            <div className='max-w-sm'>
                <label htmlFor={`hs-toggle-password-${groupId}-np`} className='mb-2 block text-sm dark:text-white'>
                    New password
                </label>
              ...
              "target": ["#hs-toggle-password-${groupId}", "#hs-toggle-password-${groupId}-np"]
                        ...
                        <svg
                            className='h-3.5 w-3.5 flex-shrink-0 text-gray-400 dark:text-neutral-600'
                            width='24'
                            height='24'
                            viewBox='0 0 24 24'
                            fill='none'
            ...
            <div className='max-w-sm'>
                <label htmlFor={`hs-toggle-password-${groupId}`} className='mb-2 block text-sm dark:text-white'>
                    Current password
                </label>
                <div className='relative'>
                    <input
