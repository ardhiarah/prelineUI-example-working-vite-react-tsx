export default function TabsItem(props: any) {
    ...
    return (
        <>
            ...
            <div className='mt-3'>
                <div id={`tabs-${groupId}-1`} role='tabpanel' aria-labelledby={`tabs-item-${groupId}-1`}>
                    <p className='text-gray-500 dark:text-gray-400'>
                        This is the <em className='font-semibold text-gray-800 dark:text-gray-200'>first</em> item&apos;s tab body.
                    </p>
                </div>
                <div id={`tabs-${groupId}-2`} className='hidden' role='tabpanel' aria-labelledby={`tabs-item-${groupId}-2`}>
                    <p className='text-gray-500 dark:text-gray-400'>
                        This is the <em className='font-semibold text-gray-800 dark:text-gray-200'>second</em> item&apos;s tab body.
                    </p>
                </div>
                <div id={`tabs-${groupId}-3`} className='hidden' role='tabpanel' aria-labelledby={`tabs-item-${groupId}-3`}>
                    <p className='text-gray-500 dark:text-gray-400'>
